...
@override
String toString() {
  return 'AIAnalysisEntity(positiveElements: $positiveElements, tendance: $tendance, improvementAxes: $improvementAxes, progressAnalysis: $progressAnalysis, conclusion: $conclusion)';
}
