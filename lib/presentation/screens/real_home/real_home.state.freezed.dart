...
mixin _$RealHomeState {
 ...
 bool get isLoading; String get surname;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RealHomeState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.surname, surname) || other.surname == surname));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,surname);

@override
String toString() {
  return 'RealHomeState(isLoading: $isLoading, surname: $surname)';
}
...
/// Create a copy of RealHomeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? surname = null,Object? isLoading = null,}) {
